...
//  Capp
//
//  Created by Tannaz Parsa on 12/23/17.
...
@objc public enum MySnackbarDuration: Int {
...
open class MySnackbar: UIView {
    ...
    public typealias TTGActionBlock = (_ snackbar:MySnackbar) -> Void
    
    /// Dismiss callback closure definition.
    public typealias TTGDismissBlock = (_ snackbar:MySnackbar) -> Void
    
    /// Swipe gesture callback closure
    public typealias TTGSwipeBlock = (_ snackbar: MySnackbar, _ direction: UISwipeGestureRecognizerDirection) -> Void
    ...
    @objc open dynamic var duration: MySnackbarDuration = MySnackbarDuration.short
    ...
    @objc open dynamic var messageTextFont: UIFont = Fonts.bold(withSize: 14) {
        didSet {
    ...
    @objc open dynamic var actionTextColor: UIColor = CappColors.gray {
        didSet {
    ...
    @objc open dynamic var actionTextFont: UIFont = Fonts.bold(withSize: 14) {
        didSet {
    ...
    @objc open dynamic var secondActionTextFont: UIFont = Fonts.bold(withSize: 14) {
        didSet {
    ...
    public override init(frame: CGRect) {
        super.init(frame: MySnackbar.snackbarDefaultFrame)
        configure()
    }
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    @objc public init(message: String, duration: MySnackbarDuration) {
        super.init(frame: MySnackbar.snackbarDefaultFrame)
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(customContentView: UIView, duration: MySnackbarDuration) {
        super.init(frame: MySnackbar.snackbarDefaultFrame)
        self.duration = duration
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(message: String, duration: MySnackbarDuration, actionText: String, actionBlock: @escaping TTGActionBlock) {
        super.init(frame: MySnackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
    ...
    /**
     ...
     - returns: TTGSnackbar instance
     */
    public init(message: String, duration: MySnackbarDuration, actionText: String, messageFont: UIFont, actionTextFont: UIFont, actionBlock: @escaping TTGActionBlock) {
        super.init(frame: MySnackbar.snackbarDefaultFrame)
        self.duration = duration
        self.message = message
        self.actionText = actionText
...
public extension MySnackbar {
    ...
    @objc public func show() {
        ...
        iconImageViewWidthConstraint?.constant = iconImageView.isHidden ? 0 : MySnackbar.snackbarIconImageViewWidth
        actionButtonMaxWidthConstraint?.constant = actionButton.isHidden ? 0 : actionMaxWidth
        secondActionButtonMaxWidthConstraint?.constant = secondActionButton.isHidden ? 0 : actionMaxWidth
        ...
        if let superView = containerView ?? UIApplication.shared.delegate?.window ?? UIApplication.shared.keyWindow {
            ...
            let minHeightConstraint = NSLayoutConstraint.init(
                ...
                toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: MySnackbar.snackbarMinHeight)
    ...
    fileprivate func showWithAnimation() {
        ...
        let snackbarHeight = systemLayoutSizeFitting(.init(width: superViewWidth - leftMargin - rightMargin, height: MySnackbar.snackbarMinHeight)).height
...
private extension MySnackbar {
    ...
    func configure() {
        ...
        contentView.frame = MySnackbar.snackbarDefaultFrame
        ...
        iconImageViewWidthConstraint = NSLayoutConstraint.init(
            ...
            toItem: nil, attribute: .notAnAttribute, multiplier: 1, constant: MySnackbar.snackbarIconImageViewWidth)
