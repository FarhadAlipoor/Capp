...
class MyRadioButtonController : NSObject {
    ...
    init(buttons: UIButton...) {
        ...
        for aButton in buttons {
            ...
            aButton.addTarget(self, action: #selector(MyRadioButtonController.pressed(_:)), for: UIControlEvents.touchUpInside)
        }
    ...
    func removeButton(_ aButton: UIButton) {
        ...
        if(iteratingButton != nil) {
            ...
            iteratingButton!.removeTarget(self, action: #selector(MyRadioButtonController.pressed(_:)), for: UIControlEvents.touchUpInside)
