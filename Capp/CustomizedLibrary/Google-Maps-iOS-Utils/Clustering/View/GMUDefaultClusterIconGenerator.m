...
- (instancetype)init {
  if ((self = [super init]) != nil) {
    ...
    _buckets = @[ @20, @50, @100, @200, @500, @1000 ];
  }
  return self;
}
...
- (UIImage *)iconForSize:(NSUInteger)size {
  ...
  text = [GMUCustomizationsHelper persianDigits: text];
...
- (UIImage *)iconForText:(NSString *)text withBaseImage:(UIImage *)image {
  ...
  UIFont *font = [UIFont fontWithName:[GMUCustomizationsHelper fontName] size:12];
  ...
  NSDictionary *attributes = @{
    ...
    NSBaselineOffsetAttributeName: [NSNumber numberWithInt: -5]
  };
